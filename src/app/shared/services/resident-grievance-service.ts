...
export class ResidentGrievanceService {
  ...
  addGrievance(formData: FormData): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/add`, formData); // Use full URL
  }
